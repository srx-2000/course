package com.srx.myapplication.fragment.left;
...
import com.srx.myapplication.fragment.left.wordFragment.OnListFragmentInteractionListener;
import com.srx.myapplication.fragment.left.dummy.WordContent.WordItem;
...
public class wordRecyclerViewAdapter extends RecyclerView.Adapter<wordRecyclerViewAdapter.ViewHolder> {
    ...
    public wordRecyclerViewAdapter(List<WordItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }

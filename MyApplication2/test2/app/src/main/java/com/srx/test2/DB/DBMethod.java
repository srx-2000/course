...
//        long flag = dbWriter.insert("word", null, values);
    ...
    public void insertSentence(ExampleSentence sentence) {
        initDBer();
     ...
     * @param newSentence
     */
    public void updateSentence(ExampleSentence newSentence) {
        initDBer();
     ...
     * @param sentenceId
     */
    public void deleteSentenceBySelf(String sentenceId) {
        initDBer();
     ...
     * @param wordId
     */
    public void deleteSentenceByword(String wordId) {
        initDBer();
